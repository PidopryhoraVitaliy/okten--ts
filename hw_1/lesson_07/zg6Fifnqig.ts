{
    ...
    class Cinderella {
        constructor(private name: string, private age: number, public footSize: number) {
            this.name = name;
            this.age = age;
    ...
    class Prince {
        constructor(private name: string, private age: number, public foundFootSize: number) {
            this.name = name;
            this.age = age;
    ...
    const firstCinderella: Cinderella | undefined = cinderellas.find(cinderella => cinderella.footSize === prince.foundFootSize);
